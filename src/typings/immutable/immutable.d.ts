...
declare module 'immutable' {
  ...
  export interface Map<K, V> extends KeyedCollection<K, V> {
     ...
     *
     *     x.updateIn(['a', 'b', 'c'], abc => abc.defaults(y));
     *     x.mergeIn(['a', 'b', 'c'], y);
     *
     */
    mergeIn(
  ...
  export function KeyedSeq<K, V>(array: Array<[K,V]>): KeyedSeq<K, V>;
  export function KeyedSeq<V>(obj: {[key: string]: V}): KeyedSeq<string, V>;
  export function KeyedSeq<K, V>(iterator: Iterator<[K,V]>): KeyedSeq<K, V>;
  export function KeyedSeq<K, V>(iterable: Iterable<K,V>): KeyedSeq<K, V>;
  ...
  export interface Iterable<K, V> {
    ...
    map<L, M>(
      mapper: (value?: V, key?: K, iter?: /*this*/Iterable<K, V>) => [L, M],
      context?: any
    ): /*this*/Iterable<L, M>;
  ...
  export function KeyedIterable<K, V>(array: Array<[K,V]>): KeyedIterable<K, V>;
  export function KeyedIterable<V>(obj: {[key: string]: V}): KeyedIterable<string, V>;
  export function KeyedIterable<K, V>(iterator: Iterator<[K,V]>): KeyedIterable<K, V>;
  export function KeyedIterable<K, V>(iterable: Iterable<K,V>): KeyedIterable<K, V>;
