...
declare module __ReactDnd {
    ...
    interface ContextComponentClass<P> extends React.Component<P, any> {
    ...
    interface DndComponentClass<P> extends React.ComponentClass<P> {
        ...
        DecoratedComponent: React.Component<P, any>;
    }
    ...
    export function DragLayer<P>(
        ...
        options?: DndOptions<P>
    ): (componentClass: React.Component<P, any>) => DndComponentClass<P>;
